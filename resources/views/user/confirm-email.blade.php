...
<body style="display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; background-color: #f5f5f5;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bold">Xác nhận Email</div>
                    <div class="card-body">
                        <p class="text-center">Nhập mã định danh đã được gửi vào email của bạn</p>
                        <form>
                            <div class="form-group">
                                <label for="security_code" class="sr-only">Security_Code</label>
                                <input id="security_code" type="email" class="form-control" name="email" required autofocus placeholder="Nhập mã định danh">
                            </div>
